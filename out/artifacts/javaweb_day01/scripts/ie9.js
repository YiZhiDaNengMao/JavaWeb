...
;(function (N, p) {
    ...
    var E = t < 6, bj = bT(), bx = p.documentElement, B, x, cy = "!",
        U = ":link{ie7-link:link}:visited{ie7-link:visited}", cz = /^[\w\.]+[^:]*$/;
    ...
    function cB(c, a) {
        ...
        return bl[c] || ""
    };var dA = Array.prototype.slice, dB = /%([1-9])/g, cC = /^\s\s*/, cD = /\s\s*$/, cE = /([\/()[\]{}|*+-.,^$?\\])/g,
        bV = /\bbase\b/, bW = ["constructor", "toString"], bm;
    ...
    var P = "#", Q = "#", bc = ".", bn = "../default.htm", dC = /\\(\d+)/g, cF = /\[(\\.|[^\]\\])+\]|\\.|\(\?/g,
        cG = /\(/g, cH = /\$(\d+)/, cI = /^\$\d+$/, cJ = /(\[(\\.|[^\]\\])+\]|\\.|\(\?)|\(/g, cK = /^<#\w+>$/,
        cL = /<#(\w+)>/g, G = F.extend({
...
#.\[\]:*
    ...
    var L = "e0=IE7._d(d,'%1');if(e0){", z = "var n=c.getElementsByTagName('%1');",
        w = "if(r==null)return e0;r[k++]=e0;", r = 1,
        A = new bb({"^((?:<#selector>)?(?:<#combinator>))(<#tag>)(<#filter>)?$": true}), s = {}, q = new bb({
